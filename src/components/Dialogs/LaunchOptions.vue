            ...
            >
                <v-list-item>
                    <template>
                        ...
                        <v-list-item-content @click="allowMultipleInstancesStore = !allowMultipleInstancesStore">
                ...
                <v-list-item>
                    <template>
                        ...
                        <v-list-item-content @click="noSteamVRStore = !noSteamVRStore">
                ...
                <v-list-item>
                    <template>
                        ...
                        <v-list-item-content @click="autoRestartInterfaceStore = !autoRestartInterfaceStore">
                ...
                <v-list-item>
                    <template>
                        ...
                        <v-list-item-content @click="dontPromptForLoginStore = !dontPromptForLoginStore">
